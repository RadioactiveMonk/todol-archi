...
[todol] @lru_cache → Simuler une fonction coûteuse qu'on met en cache
[todol] defaultdict → Regrouper des favoris par domaine (très visuel)
[todol] := (walrus) → Dans une boucle d’input ou de filtrage
