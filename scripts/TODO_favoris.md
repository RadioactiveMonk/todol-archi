...
- [ ] Charger les données (liste de dicts)
- [ ] Gérer les erreurs de chargement JSON (try/except)

### [ ] Menu principal
- [ ] Afficher les options (ajouter / supprimer / lister / quitter)
- [ ] Boucle continue jusqu'à quitter volontairement
